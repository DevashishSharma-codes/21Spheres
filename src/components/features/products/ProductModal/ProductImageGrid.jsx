...
const PRODUCT_GALLERIES = {
  ...
  "bimakart-center": [
    { title: "Dashboard", src: "https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?auto=format&fit=crop&w=1600&q=85" },
  ...
  "policy-ocr-fraud": [
    { title: "Dashboard", src: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=1600&q=85" },
...
export const ProductImageGrid = ({ product }) => {
  ...
  const handleLaunchProject = () => {
    window.open(product?.demoUrl || "https://21spheres.com", "_blank", "noopener,noreferrer");
  };
