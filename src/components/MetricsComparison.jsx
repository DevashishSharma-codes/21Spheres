...
export const MetricsComparison = ({
  ...
  paragraphs = [
    <>
      Other agencies build slow generic templates. 21Spheres automates deterministic{" "}
      <em style={{ fontStyle: "italic" }}>architecture</em>. 200+ micro-optimizations per project — zero-friction identity OCR, edge AI latency, sub-50ms cloud pipelines — turned into software that scales effortlessly under load.
    </>,
    `21Spheres ships code so fast & resilient — founders say "How the hell did you scale this so smoothly?"`,
  ],
  chartData = [
  ...
  scaleMax = 30,
  gridStep = 5,
  quote = "I've been building enterprise platforms for 12 years and I've never worked with an engineering team like 21Spheres before — we had legacy monoliths and 21Spheres built us an automated OCR & cloud architecture that scaled our throughput 10x effortlessly.",
  name = "Jason Hardman",
